...
def fix_package_structure(
    ...
    source_dirs = [
        ...
        project_dir / "data" / "network" / "src" / "commonMain" / "kotlin",
        project_dir / "data" / "disk" / "src" / "commonMain" / "kotlin",
        project_dir / "data" / "disk" / "src" / "androidMain" / "kotlin",
        project_dir / "data" / "disk" / "src" / "iosMain" / "kotlin",
        project_dir / "data" / "disk" / "src" / "commonMain" / "sqldelight",
